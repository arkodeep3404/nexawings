    ...
    >
      ...
      >
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Automate your processes by leveraging the power of AI and Custom
          Software. Cut costs, earn more, and focus only on the highest value
          activities.
        </p>
      </div>
      <div
      ...
      >
        <img
          src={robot}
          alt="billing"
          className="w-[100%] h-[100%] relative z-[5] ml-28"
        />
